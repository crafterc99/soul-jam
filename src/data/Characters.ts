...
export const CHARACTERS: Record<string, CharacterDef> = {
  ninetynine: {
    ...
    color: 0x00ccff,
    spriteKey: 'char-99',
    dribbleAnimKey: '99-dribble-anim',
    idleDribbleAnimKey: '99-static-dribble-anim',
    defensiveSlideLeftAnimKey: '99-defense-shuffle-anim',
    defensiveSlideRightAnimKey: '99-defense-shuffle-anim',
    jumpshotAnimKey: '99-jumpshot-anim',
    stepbackAnimKey: '99-stepback-anim',
    crossoverAnimKey: '99-crossover-anim',
    defenseBackpedalAnimKey: '99-defense-backpedal-anim',
    defenseShuffleAnimKey: '99-defense-shuffle-anim',
    stealAnimKey: '99-steal-anim',
    ratings: {
      speed: 92,
      power: 68,
      range: 72,
